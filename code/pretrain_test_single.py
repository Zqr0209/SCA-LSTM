...
if __name__ == '__main__':
    ...
    for idx, exp_config in enumerate(exps_config):
        ...
        SeedMethods.seed_torch(seed=seed)
        root_now = saving_root / f"pub_test_single_w0" / exp_config["tag"]
    ...
    result_dir = saving_root / f"test_result_w0"
