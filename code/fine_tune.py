...
from utils.train_full import train_full_fine_tune
...
if __name__ == '__main__':
    ...
    for idx, exp_config in enumerate(exps_config):
        ...
        train_full_fine_tune(pre_model, decode_mode, train_loader, val_loader, optimizer, scheduler, loss_func, n_epochs, device,
                   root_now)
